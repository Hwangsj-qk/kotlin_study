...
fun main() {
    ...
    val odds = numbers.filter { it % 2 == 1 }       // 매개변수가 1개면 it 사용 가능
    println(evens)      // 짝수
    println(odds)       // 홀수
    ...
    println(flatNumbers)        // 1,2,3,10,20,30
