...
/*
    ...
    - 입금(deposit)과 출금(withdraw) 메서드를 구현합니다.
    출금 시 잔액보다 많은 금액을 출금하려고 하면 오류 메시지를 출력합니다.
...
class BankAccount(var balance : Int = 0) {
    ...
    fun withdraw(amount: Int) {
        if(amount > balance) println("잔액부족 : 출금할 수 없습니다. ") else balance -=amount
    }
}
...
fun main() {
    ...
    println("현재잔고: ${bankAccount.balance}")
